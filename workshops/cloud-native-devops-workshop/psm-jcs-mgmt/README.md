...
To find out your identity domain ID or identity service ID, sign in to Oracle Cloud My Services, and click any Service Type (such as Java and Application Container). On the resulting Service Overview page, look for the “Identity Domain Id” or "Identity Service Id" field, depending on your account type.
